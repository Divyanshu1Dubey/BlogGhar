...
const socialLinks = [
  { name: 'Twitter', href: 'https://twitter.com/bloghar' },
  { name: 'Facebook', href: 'https://facebook.com/bloghar' },
  { name: 'Instagram', href: 'https://instagram.com/bloghar' },
  { name: 'YouTube', href: 'https://youtube.com/@bloghar' },
];
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubscribe} className="flex gap-2 w-full lg:w-auto">
                <input
                  ...
                  required
                />
                <button type="submit" className="bg-primary-600 text-white whitespace-nowrap px-5 py-2.5 rounded-lg font-semibold hover:bg-primary-700 transition-colors">
                  Subscribe
                </button>
              </form>
            )}
            ...
            <div className="flex gap-3 mt-5">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="p-2.5 bg-gray-800 rounded-lg hover:bg-primary-600 text-gray-400 hover:text-white transition-all duration-200"
                >
